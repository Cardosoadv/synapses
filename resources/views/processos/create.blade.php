...
<div class="container-narrow">
    <div class="info-block">
        ...
        <h1 class="mt-1 fs-1-5">Novo Processo</h1>
    ...
    <div class="glass section-glass">
        <form action="{{ route('processos.store') }}" method="POST">
            ...
            <div class="grid-2nd form-group">
                <div>
                    <label class="form-label-required form-label">Tipo de Processo</label>
            ...
            <div class="form-group">
                <label class="form-label-required form-label">Assunto</label>
                <input type="text" name="assunto" class="form-control" value="{{ old('assunto') }}" required placeholder="Título ou resumo do processo">
            </div>

            <div class="form-group">
                <label class="form-label-required form-label">Nível de Acesso</label>
