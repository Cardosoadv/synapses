    ...
    <div class="detail-header">
        ...
        <div class="detail-actions">
            <form action="{{ route('processos.update-status', $processo->id) }}" method="POST" id="status-form">
                @csrf
                @method('PATCH')
                <select name="status" class="form-control status-select w-auto bg-dark-select" aria-label="Alterar status do processo">
            ...
            <button class="btn btn-primary" title="Adicionar Documento" aria-label="Adicionar novo documento ao processo">
                    ...
                    @forelse($processo->movimentacoes->sortByDesc('created_at') as $movimentacao)
                        <div class="timeline-item">
                            ...
                            <div class="td-main">
                                ...
                                <p class="fs-0-85 mt-0-25">{{ $movimentacao->observacao }}</p>
