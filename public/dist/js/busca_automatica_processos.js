...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function sendDataToProcessarIntimacoes(jsonData, url) {
        ...
        .then(responseData => {
            ...
            if (responseData.success) {
                showMessage(`✓ Sucesso para ${urlFormatada}: ${responseData.message} (Processadas: ${responseData.processadas})`, 'success');
    ...
    async function processarTodasUrls() {
        ...
        if (urls.length === 0) {
            showMessage('Nenhuma URL de processo para processar.', 'info');
