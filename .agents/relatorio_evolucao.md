...
## [v1.3.0] - 2026-05-09
### Adicionado
- **Sistema de Classes Utilit├írias**: Implementa├º├úo de um micro-framework de utilit├írios CSS (dimens├Áes, espa├ºamento, tipografia) para padroniza├º├úo da UI.
- **Identifica├º├úo Visual de Campos Obrigat├│rios**: Cria├º├úo da classe `.form-label-required` que adiciona automaticamente um asterisco vermelho via pseudo-elemento CSS.
- **Aprimoramento de Acessibilidade**:
    - Implementa├º├úo de `role="alert"` em mensagens de feedback do sistema.
    - Uso de `aria-current="page"` para identifica├º├úo sem├óntica do item ativo no menu de navega├º├úo.
    - Remo├º├úo de redund├óncias de `role="button"` em elementos HTML sem├ónticos.
- **Refatora├º├úo Completa de Views**: Extra├º├úo final de estilos inline remanescentes nas views de Login, Processos e Usu├írios, reduzindo o acoplamento visual e facilitando o cache de assets.
: Antigravity AI*